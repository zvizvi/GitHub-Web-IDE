...
const ideWebsitesList = [
  ...
  },
  {
    ...
    platforms: ['github'],
    openInNewTab: true,
    icon: '<svg width="16" height="16" viewBox="0 0 24 24" class="mr-2" style="vertical-align:sub"><path d="M0 0h23.987v24H0V0Zm21.533 2.455v19.09H2.453V2.456h19.08Z" fill="var(--color-fg-default)" fill-rule="evenodd" clip-rule="evenodd"></path></svg>'
  },
  {
    title: 'GitHub1s',
    name: 'gitHub1s',
