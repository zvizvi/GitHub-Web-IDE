...
const ideWebsitesList = [
  ...
  },
  {
    ...
    title: 'PyCharm',
    name: 'cloneInPyCharm',
    baseurl: 'pycharm://open?file=',
    platforms: ['github'], // or whatever platforms you want to support
    icon: '<img src="https://upload.wikimedia.org/wikipedia/commons/1/1d/PyCharm_Icon.svg" alt="PyCharm" />', // Replace with your PyCharm icon
    class: 'd-none d-md-block'
  }
...
function cloneInPyCharm () {
  const repoUrl = location.href;
  const filePath = '/path/to/your/local/repository'; // Replace with the path to your local repository

  // This command is just an example and might not work in your case.
  // You'll need to replace it with the actual command to open a file in PyCharm.
  const command = `${ideWebsitesList.find((item) => item.name === 'pycharm').baseurl}${filePath}`;
